...
public class HODmenuController extends Application{
    ...
    public void start(Stage primaryStage) {
		try {
			BorderPane root = (BorderPane)FXMLLoader.load(getClass().getResource("/gui/HODmenu.fxml"));
			Scene scene = new Scene(root);
			primaryStage.initStyle(StageStyle.UNDECORATED);
			primaryStage.getIcons().add(new Image("/Images/CemsIcon32-Color.png"));

			scene.getStylesheets().add(getClass().getResource("/gui/HODmenuCSS.css").toExternalForm());
